...
<template>
    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-foreground/40"
                >
                    Dashboard
                </Link>
                <template v-else>
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-card p-6 pb-12 text-[13px] leading-[20px] text-foreground shadow-[inset_0px_0px_0px_1px_var(--border)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            <span class="relative bg-card py-1">
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]"
                                >
                                    <span
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="inline-block rounded-sm border border-primary bg-primary px-5 py-1.5 text-sm leading-normal text-primary-foreground hover:opacity-90"
                            >
                                Deploy now
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-secondary/30 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <svg
                        class="w-full max-w-none translate-y-0 text-destructive opacity-100 transition-all duration-750 starting:translate-y-6 starting:opacity-0"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
