...
<template>
    <tr class="group/row transition-colors hover:bg-muted/30">
        <td class="w-px py-3 pr-2 pl-4 align-top">
            <button
                v-if="hasCompanions"
                type="button"
            ...
            <div class="flex min-w-0 flex-1 items-start gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    >
                        ...
                        <span v-if="subline.pending" class="ml-1 text-warning">{{
                            subline.pending
                        }}</span>
                    </p>
                </div>
        ...
        <td
            class="admin-type-data px-4 py-3 text-center text-muted-foreground uppercase"
        >
