/** Mock data for the guests admin demo. Only the precomputed views are exported. */
...
// Coverage notes for this demo:
//   - gg_01 (María Gómez) and gg_04 (Carlos Pérez) are lone primaries
//     → exercise the Join button.
//   - groups with companions (gg_02, gg_03, gg_05, gg_06, …) → Split.
//   - non-pending companions → Move and Leave.
//   - pending companions (gg_03, gg_08, gg_13) → Move/Leave NOT visible.
// ---------------------------------------------------------------------------
